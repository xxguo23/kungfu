...
int valid_learn(object me)
{
       ...
       /* if ((string)me->query("gender") != "女性") 
        	return notify_fail("庄子舞乃是至阴至柔之功，你如何可以修习？\n"); */

        if (me->query("dex") < 36 && me->query("family/family_name") != "红花会")
                return notify_fail("你先天身法太差，无法学习庄子舞。\n");
                
         if (me->query("dex") < 26 && me->query("family/family_name") == "红花会")
                return notify_fail("你先天身法太差，无法学习庄子舞。\n");
